...
if __name__ == '__main__':
    train_dataset = NABirds('/media/nkondapa/SSD2/data/nabirds/', train=True, download=False)
    test_dataset = NABirds('/media/nkondapa/SSD2/data/nabirds/', train=False, download=False)
    all_dataset = NABirds('/media/nkondapa/SSD2/data/nabirds/', train=None, download=False)
