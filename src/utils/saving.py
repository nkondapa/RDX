...
model_names = {
    ...
    'resnet_fbhc_adam_optim_CosAnneal': 'r18_fbhc_aoca',
}

param_value_names = {
    'image_group_strategy': {'union': 'u', 'intersection': 'i', 'craft': 'c', 'topkprobs': 't',
                             'topkprobs-union': 'tu', 'ground_truth': 'gt'},
    ...
    'skip_cka': lambda x: '',
    'dataset_name': {'imagenet': 'in', 'nabirds': 'nb', 'cub': 'cub', 'nabirds_modified': 'nb_mod',
                     'nabirds_stanford_cars': 'nbsc', 'funny_birds': 'fb'},
    ...
    'topk_group_size': lambda x: f'{x}',
    'topk_prob_thresh': lambda x: f'{x}',
}
param_key_names = {
    ...
    'topk_group_size': 'tkgs=',
    'topk_prob_thresh': 'tkpt=',
}
...
comparison_method_param_value_names = {
    ...
    'image_group_strategy': {'union': 'u', 'intersection': 'i', 'craft': 'c', 'topkprobs': 't',
                             'topkprobs-union': 'tu', 'ground_truth': 'gt'},
    'num_concepts': lambda x: f'{x}',
    'max_iters': lambda x: f'{x}',
    'l2_nonneg_pen_lambda': lambda x: f'{x}',
    'exponentiate': {True: 'nn_exp', False: ''},
    'softplus': {True: 'nn_sp', False: ''},
    'explicit_norm': {True: 'exp_norm', False: ''},
    'relu': {True: 'relu', False: ''},
    'relu_threshold': lambda x: f'{x}',
}
