...
def concept_extraction_parser():
    ...
    parser.add_argument('--image_group_strategy', type=str, default="topkprobs")
    ...
    parser.add_argument('--topk_group_size', type=int, default=5)
    parser.add_argument('--topk_prob_thresh', type=float, default=0.0)
...
def concept_comparison_parser_acmtf():
    parser = argparse.ArgumentParser()
...
def representation_comparison_parser():
    parser = argparse.ArgumentParser()

    parser.add_argument('--comparison_config', type=str, required=True)
    parser.add_argument('--comparison_output_root', type=str, default='./outputs/')
    parser.add_argument('--folder_exists', type=str, default='skip')
