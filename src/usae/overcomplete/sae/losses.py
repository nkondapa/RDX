...
def top_k_auxiliary_loss_L1(x, x_hat, pre_codes, codes, dictionary, penalty=0.1):
    """
    A modification of the top k aux loss, using L1 instead of L2 distances.
    ...
    residual_hat = pre_codes @ dictionary
    auxilary_mse = (residual - residual_hat).abs().mean()
