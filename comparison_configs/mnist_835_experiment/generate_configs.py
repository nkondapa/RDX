...
sweep_param_values = [
    # f"{root_folder}/checkpoints/mnist_835/epoch=0-step=0.ckpt",
    # f"{root_folder}/checkpoints/mnist_835/epoch=0-step=32.ckpt",
    # f"{root_folder}/checkpoints/mnist_835/epoch=0-step=56.ckpt",
    # f"{root_folder}/checkpoints/mnist_835/epoch=0-step=136.ckpt",
    # f"{root_folder}/checkpoints/mnist_835/epoch=1-step=160.ckpt",
    f"{root_folder}/checkpoints/mnist_835/epoch=1-step=184.ckpt",
    # f"{root_folder}/checkpoints/mnist_835/epoch=1-step=272.ckpt",
    # f"{root_folder}/checkpoints/mnist_835/epoch=2-step=408.ckpt",
    # f"{root_folder}/checkpoints/mnist_835/epoch=3-step=544.ckpt",
    # f"{root_folder}/checkpoints/mnist_835/epoch=4-step=680.ckpt",
]
